...
const projects = [
  {
    title: "CollabEditor",
    description:
      "Real-time collaborative code editor with multi-user rooms, live cursors, typing indicators, and language synchronization using WebSockets.",
    stack: ["React", "Node.js", "Socket.io", "WebSockets", "Vercel", "Render"],
    image: "/Document.png",
    liveUrl: "https://collab-editor-chi.vercel.app",
    githubUrl: "https://github.com/DarshanPotnis/CollabEditor",
  },
  {
  ...
  return (
    <main className="bg-[#0f1115] text-slate-50">
      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-start pt-16 sm:pt-20 px-6 text-center">
        <div className="relative w-52 h-52 sm:w-64 sm:h-64 md:w-72 md:h-72 mb-8
                        rounded-full border-4 border-lime-500/60
                        shadow-[0_0_40px_rgba(190,242,100,0.25)] overflow-hidden">
          <img src="/Darshan_memoji.png" alt="Darshan Potnis" className="w-full h-full object-cover" />
        </div>
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold max-w-5xl leading-tight">
        ...
        <div className="mt-10 flex gap-4 flex-wrap justify-center">
          <motion.a href="#projects" className="px-7 py-3 rounded-xl border border-lime-400/40 text-lime-300 font-semibold">
            View Projects
          </motion.a>
          <motion.a href="#skills" className="px-7 py-3 rounded-xl border border-lime-400/40 text-lime-300 font-semibold">
            View Tech Stack
          </motion.a>
          <motion.a href="/Darshan_Potnis_Resume_2026.pdf" target="_blank" className="px-7 py-3 rounded-xl border border-lime-400/40 text-lime-300 font-semibold">
            Download Resume
          </motion.a>
        </div>
      </section>
